...
const ShoppingCartScreen = ({ route, navigation }) => {
  ...
  const onAddDistrictData = async (cityId) => {
    try{
      const response = await fetch("https://thongtindoanhnghiep.co/api/city/"+cityId+"/district",{
        method:"GET",
        headers:{
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  const onAddWardData = async (districtId) =>{
    try{
      const response = await fetch("https://thongtindoanhnghiep.co/api/district/"+districtId+"/ward",{
        method:"GET",
        headers:{
          Accept: "application/json",
          "Content-Type": "application/json",
    ...
    return (
      ...
      <View style={style.container}>
        ...
        <ConfirmBuyItemButton
          onPress={() => navigation.navigate("ConfirmBuyingScreen")}
        />
        </ScrollView> 
        </View>
      </View>
